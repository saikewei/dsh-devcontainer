 ...
 *
 * Deliberately shallow. `Match` blocks, `Include` directives and multi-alias `Host` lines
 * are handled only as far as they affect the alias list; a directive this parser does not
