...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const inject = ['slots', 'uiWorkspace', 'sidebarRightTabs']
    ...
    function ContainerFileBody(props) {
      ...
      if (state.phase === 'error') {
        return h('div', { className: 'dshDc_fileWrap' }, [
          h('div', { key: 'bar', className: 'dshDc_fileBar' }, [
            h('span', { key: 'p', className: 'dshDc_filePath', title: text(path) }, text(path)),
            h('button', {
              key: 'again',
              type: 'button',
              className: 'dshDc_btn dshDc_btnSec',
      ...
      return h('div', { className: 'dshDc_fileWrap' }, [
        h('div', { key: 'bar', className: 'dshDc_fileBar' }, [
          h(
            'span',
            { key: 'p', className: 'dshDc_filePath', title: text(payload.remotePath) },
            text(payload.remotePath),
          ),
        ...
        payload.text === ''
          ...
          : h('pre', { key: 'c', className: 'dshDc_fileCode' }, text(payload.text)),
      ])
    }
